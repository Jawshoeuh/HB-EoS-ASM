...
; This is my questionable PLA interpretaiton of Spikes. It leaves a lot of
; things to be desired. Why not always just call the DoTrapSpike on the
; target? Why not use the function to update the trap to the minimap? Why
; activate the trap below? It's just really silly all around...
